...
![Author: Jean V](https://img.shields.io/badge/Author-Jean%20V-green)
...
Crie um arquivo `.env` e coloque sua chave:
...
# Deixe o cérebro pensar com alma brasileira

resposta = brain.think("E aí, qual a boa de hoje?")

print(f"Klipza diz: {resposta}")
...
Para garantir que o cérebro não está "alucinando" e mantém a alma BR:
...
*Todos os testes devem passar com 100% de cobertura no core.*
...
*Criado por @neaj_japan · Klipza Studio*
